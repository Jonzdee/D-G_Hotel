        ...
        {rooms.length > 0 ? (
          rooms.map(room => (
            <div key={room.id} className="bg-white border border-gray-300 rounded-lg overflow-hidden shadow-md">
              <Slider {...settings}>
                <img src={room.asset1} alt={room.categoryType} className="w-full h-56 object-cover" />
                <img src={room.asset2} alt={room.categoryType} className="w-full h-56 object-cover" />
                <img src={room.asset3} alt={room.categoryType} className="w-full h-56 object-cover" />
                <img src={room.asset4} alt={room.categoryType} className="w-full h-56 object-cover" />
              </Slider>
              <div className="p-4">
