        ...
        <div className="grid grid-cols-1 md:grid-cols-2 gap-8">
          {['Asset1', 'Asset2', 'Asset3', 'Asset4'].map((asset, index) => (
            room[asset] ? (
              ...
              <div key={index} className="w-full h-56 bg-gray-200 rounded-lg shadow-lg flex items-center justify-center">
                <span>No Image</span>
              </div>
            )
          ))}
          ...
          <div className="space-y-6">
            <div className="border-b pb-4">
              ...
              <div className="flex space-x-1 mt-2">
                {[...Array(5)].map((_, i) => (
                  <svg key={i} className="w-5 h-5 text-yellow-400 transition-transform transform duration-300 hover:scale-125" fill="currentColor" viewBox="0 0 20 20">
                    <path d="M10 15l-3.5 2.1L7 12 4 8.5l3.9-.4L10 2l2.1 5.7L16 8.5 12 12l.5 5.1L10 15z" />
                  </svg>
                ))}
              </div>
            </div>
            <div className="border-b pb-4">
              ...
              <div className="flex space-x-1 mt-2">
                ...
                <svg className="w-5 h-5 text-gray-300 transition-transform transform duration-300 hover:scale-125" fill="currentColor" viewBox="0 0 20 20">
                  <path d="M10 15l-3.5 2.1L7 12 4 8.5l3.9-.4L10 2l2.1 5.7L16 8.5 12 12l.5 5.1L10 15z" />
                </svg>
              </div>
            </div>
